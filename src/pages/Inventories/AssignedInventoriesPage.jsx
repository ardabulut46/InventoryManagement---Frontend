...
const AssignedInventoriesPage = () => {
    ...
    return (
        <Box>
            ...
            <Box sx={{ mb: 3, position: 'sticky', top: 0, zIndex: 10, bgcolor: theme.palette.background.paper, pt:1, pb: 1 }}> {/* Added pt:1 for some spacing if header is very close */}
                <TextField
                    fullWidth
                    variant="outlined"
                ...
                />
                {/* Removed the Box with Chips that was previously here */}
            </Box>
